...
object FramePipeline {
  ...
  def apply(frame: Mat): FramePipeline = {
    ...
    } yield FramePipeline(frame, working, grayed, blurred, thresholdApplied, inverted, dilated, eroded), Duration.Inf)
  }
...
/**
  ...
  */
case class FramePipeline(frame: Mat, working: Mat, grayed: Mat,
